...
```{r, zip, eval=FALSE}
cd ~
zip -r tutor.zip tutorial-unix-basics
```
...
```{r, tar1}
cd ~
tar -cvf tutorial.tar tutorial-unix-basics
ls -l tutorial.tar
rm tutorial.tar
```
```{r, tar2}
cd ~
tar -cvzf tutorial.tgz tutorial-unix-basics
ls -l tutorial.tgz
```
```{r, tar3}
cd ~
...
if [ -f ~/tutorial.tgz ]; then rm -rf ~/tutorial.tgz
fi
if [ -f ~/tutorial.tgz ]; then rm -rf ~/tutorial.tgz
fi
