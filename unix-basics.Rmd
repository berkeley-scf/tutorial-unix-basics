...
4) Use both `zip` and `tar -cvzf` to compress the stat243-fall-2014 directory. Is one much smaller than the other?
...
if [ -f ~/stat243-fall-2014/units/unit9-parallel-processing.R ]; then mv -f ~/stat243-fall-2014/units/unit9-parallel-processing.R ~/stat243-fall-2014/units/unit8-parallel.R
fi
```
