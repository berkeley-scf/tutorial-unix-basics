...
3) Change the permissions on the file stat243-fall-2014/units/unit1-unix.sh to be readable by the owner and the group, writeable by the owner, and executable by all users.
